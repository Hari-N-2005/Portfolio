...
export const skillsData = [
  {
    ...
    skills: [
      ...
      { name: "Redux", logo: "https://img.shields.io/badge/Redux-593D88?style=for-the-badge&logo=redux&logoColor=white" },
      { name: "Vue", logo: "https://img.shields.io/badge/Vue.js-35495E?style=for-the-badge&logo=vuedotjs&logoColor=4FC08D" }
    ]
  },
  {
    id: 2,
    title: "Backend",
    skills: [
      { name: "Node.js", logo: "https://img.shields.io/badge/Node.js-339933?style=for-the-badge&logo=nodedotjs&logoColor=white" },
      { name: "Express", logo: "https://img.shields.io/badge/Express.js-000000?style=for-the-badge&logo=express&logoColor=white" }
    ]
  },
  {
    id: 3,
    title: "Databases",
    skills: [
      { name: "MongoDB", logo: "https://img.shields.io/badge/MongoDB-4EA94B?style=for-the-badge&logo=mongodb&logoColor=white" },
      { name: "MySQL", logo: "https://img.shields.io/badge/MySQL-005C84?style=for-the-badge&logo=mysql&logoColor=white" }
    ]
  },
  {
    id: 4,
